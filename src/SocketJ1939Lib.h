...
//	-1	: Сокет закрыт
//	-255	: Не знамо что
int SocketRead (int Socket, struct J1939FrameBag *Bags, unsigned int BagsCount, int TimeoutMs);
...
int SocketWrite (int Socket, struct J1939Frame *Frame, int FramesCount);
